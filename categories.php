<?php
    ...
    include "./instalacion/conexion.php";
    $consultaGeneral = $conect->prepare('SELECT * FROM categoria');
    $consultaGeneral->execute();
    $categorias = $consultaGeneral->fetchAll();
?>
<!DOCTYPE html>
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          <a
                            ...
                            aria-label="Edit"
                            href="./edit_category.php?id_categoria=<?= $valor['id_categoria'] ?>"
                          >
                            <svg
                              class="w-5 h-5"
                              aria-hidden="true"
                          ...
                          <a
                            class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Delete"
                            href="./inactivo.php?id_categoria=<?= $valor['id_categoria'] ?>"
                          >
                            <svg
                              class="w-5 h-5"
                              aria-hidden="true"
