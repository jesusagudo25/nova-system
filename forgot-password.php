...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  <body>
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <a class="hidden w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="./index.php" id="regresar">Return to login</a>
              <p class="mt-4">
                <a
                  class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline"
                  href="./index.php"
                >
                 Already have an password? Login
                </a>
              </p>
            </div>
          </div>
    ...
    <script src="./assets/js/sendpassw.js"></script>
  </body>
</html>
