<?php
    ...
    $consultaPorId = $conect->prepare('SELECT * FROM categoria WHERE id_categoria = :id');
    $consultaPorId->execute(
        ['id'=>$id]
    );
    $categoria = $consultaPorId->fetch();
...
<div class="flex flex-col flex-1 w-full">
  ...
  <?php include "./layout/header.php"; ?>
        ...
        <div class="container px-6 mx-auto grid">
            ...
            <form method="POST">
              ...
              <div class="flex items-center" style="justify-content: center;">
                <input type="submit" value="Actualizar categoria" class="px-4 py-2 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
              </div>
              </form>
            </div>
          </div>
    ...
    <script src="./assets/js/validatecategorys.js"></script>
  </body>
</html>
